# sertifikat_kompetensi-contracts
...
By default the template creates a single `HelloWorld` contract under sertifikat_kompetensi folder in the `smart_contracts` directory. To add a new contract:
